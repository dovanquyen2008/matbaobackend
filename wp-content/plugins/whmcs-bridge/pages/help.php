...
<p>
    <button class="button-positive" onclick="jQuery('#whmcs-check-results').html(''); jQuery('#whmcs-check').show(); jQuery.post(ajaxurl, { action: 'check_bridge' }, function(data) { jQuery('#whmcs-check-results').html(data); jQuery('#whmcs-check').hide(); }); return false;">
