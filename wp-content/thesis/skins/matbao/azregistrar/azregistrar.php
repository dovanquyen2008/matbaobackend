 ...
 * @return array
 */
function azregistrar_MetaData()
{
    return array(
        'DisplayName' => 'AZ Registrar Module for WHMCS',
        'APIVersion' => '1.1',
    );
}
 ...
 * @return array
 */
function azregistrar_getConfigArray()
{
    return array(
        // Friendly display name for the module
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'AZ Registrar Module for WHMCS',
        ),
 ...
 * @return array
 */
function azregistrar_RegisterDomain($params)
{
 ...
 * @return array
 */
function azregistrar_TransferDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_RenewDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_GetNameservers($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_SaveNameservers($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_GetContactDetails($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_SaveContactDetails($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 */
function azregistrar_CheckAvailability($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 */
function azregistrar_DomainSuggestionOptions() {
    return array(
        'includeCCTlds' => array(
 ...
 * @return \WHMCS\Domains\DomainLookup\ResultsList An ArrayObject based collection of \WHMCS\Domains\DomainLookup\SearchResult results
 */
function azregistrar_GetDomainSuggestions($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 */
function azregistrar_GetRegistrarLock($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_SaveRegistrarLock($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 */
function azregistrar_GetDNS($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_SaveDNS($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_IDProtectToggle($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 *
 */
function azregistrar_GetEPPCode($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_ReleaseDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_RequestDelete($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_RegisterNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_ModifyNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_DeleteNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_Sync($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * @return array
 */
function azregistrar_TransferSync($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 * the `azregistrar_push` function when invoked.
 *
 * @return array
 */
function azregistrar_ClientAreaCustomButtonArray()
{
    return array(
        'Push Domain' => 'push',
    );
 ...
 * @return array
 */
function azregistrar_ClientAreaAllowedFunctions()
{
    return array(
        'Push Domain' => 'push',
    );
 ...
 * @return array
 */
function azregistrar_push($params)
{
    // user defined configuration values
    $userIdentifier = $params['API Username'];
    $apiKey = $params['API Key'];
 ...
 */
function azregistrar_ClientArea($params)
{
    $output = '
